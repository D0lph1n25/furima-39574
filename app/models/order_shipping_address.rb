class OrderShippingAddress
  ...
  def save
    ...
    ShippingAddress.create(postal_code: postal_code, city: city, addresses: addresses, building: building, phone_number: phone_number, prefecture_id: prefecture_id, order_id: order.id)
  end
end